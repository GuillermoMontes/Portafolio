              ...
              <div className="container">
                  ...
                  <div className="split-about">
                    <motion.div initial={{x: '-100%', opacity: 0}} whileInView={horizontal} className="about-content">
                        <p>Mi interés por el desarrollo web comenzó en 2022 cuando me anoté en el curso "Maxi Programa". Fui muy autodidacta en los comienzos hasta que pude sentir el progreso cuando continué haciendo cursos como en "Codearock","Coder House" y "Educación It". 
